...
function About() {
    ...
    return (
      <div className="rounded-lg border border-primary shadow-lg bg-primary" key={id}>
        ...
        <div className="overflow-hidden transition-height duration-300 ease-out">
          {isExpanded && (
            <div className={`py-3 sm:py-5 px-5 sm:px-10 border-t border-primary text-subtitle`}>
              {parrafo}
            </div>
          )}
        </div>
  ...
  return (
    <main className="md:px-20 w-full h-full bg-secondary">
      <section className="w-full h-auto pt-20 md:py-24 lg:py-32">
        <div className="container sm:flex px-4 space-y-10 sm:space-y-0 md:px-6 2 lg:gap-16">
          <div className="w-full space-y-4">
            ...
            <p className="max-w-[700px] text-subtitle text-sm md:text-lg">
      ...
      <section className="w-full h-screen flex flex-col items-center justify-center">
        <section className="hidden w-full h-full sm:flex flex-col items-center justify-center ">
          <h1 className="text-4xl font-bold w-3/5 text-center text-title">
        ...
        <section className="laptop:hidden w-full items-center justify-center px-[20px]">
          <h1 className="text-xl font-bold text-center text-title">
            Con Clientes en los Principales Departamentos del País
          </h1>
          <IconMapaMobile />
        </section>
