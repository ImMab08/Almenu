        ...
        <div className="container grid gap-8 lg:grid-cols-2 lg:gap-16">
          ...
          <form className="grid gap-4 border border-secondary rounded-lg p-5 shadow-xl space-y-5">
            <div className="space-y-2 sm:space-y-1 flex flex-col items-center justify-center border-b-2 border-secondary pb-8">
              ...
              <p className="text-xs sm:text-sm w-3/5 text-center text-gray-600">Rellena el siguiente formulario y nos pondremos en contacto contigo lo antes posible.</p>
            </div>
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                <label className="text-base text-secondary font-semibold leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" for="name">Nombre</label>
              ...
              <div className="space-y-2">
                <label className="text-base text-secondary font-semibold leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" for="email">Correo Eléctronico</label>
            ...
            <div className="space-y-2">
              <label className="text-base text-secondary font-semibold leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" for="message">Mensaje</label>
            ...
            <button className="inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-2 disabled:opacity-50 bg-secondary text-primary hover:bg-tertiary h-10 px-4 py-2 justify-self-end" type="submit">
              Enviar
            </button>
          </form>
        </div>
