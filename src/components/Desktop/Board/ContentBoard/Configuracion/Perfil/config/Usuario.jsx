      ...
      <div className="grid grid-cols-2 gap-5 my-3">
        <div className="flex flex-col">
          ...
          <div className="flex space-x-1 border-border border-b-2">
            <p className="mt-2 text-subtitle full">{usuario?.nombre}</p>
            <p className="mt-2 text-subtitle full">{usuario?.apellido}</p>
          </div>
        </div>
        <div className="flex flex-col">
          <h2 className="text-sm font-medium text-title">Correo Eléctronico</h2>
          <p className="mt-2 text-subtitle border-border border-b-2 full">{usuario?.email}</p>
        </div>
        <div className="flex flex-col">
          <h2 className="text-sm font-medium text-title">Celular</h2>
          <p className="mt-2 text-subtitle border-border border-b-2 full">{usuario?.celular}</p>
        </div>
        <div className="flex flex-col">
          <h2 className="text-sm font-medium text-title">Plan</h2>
          <p className="mt-2 text-subtitle border-border border-b-2 full">{usuario?.plan}</p>
        </div>
      </div>    
